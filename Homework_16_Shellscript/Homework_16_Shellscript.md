...
+ ***Пятая строка***. 
   1. Тут в качестве аргумента переменной будет подстановка команд. Принцип `$()` похож на бэктикс, отличие - эта форма допускает вложеность.
